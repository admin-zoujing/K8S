...
sed -i 's|KUBE_ETCD_SERVERS="--etcd-servers=http://127.0.0.1:2379"|KUBE_ETCD_SERVERS="--etcd-servers=http://192.168.8.50:2379,http://192.168.8.51:2379"|' /etc/kubernetes/apiserver 
